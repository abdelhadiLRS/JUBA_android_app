...
public class Trip_Status {
    ...
    public String getRecepientHName() {
        return RecepientHName;
    }

    public void setRecepientHName(String recepientHName) {
        RecepientHName = recepientHName;
    }

    public String getRecepientHNum() {
        return RecepientHNum;
    }

    public void setRecepientHNum(String recepientHNum) {
        RecepientHNum = recepientHNum;
    }

    public String getRecepientHAddress() {
        return RecepientHAddress;
    }

    public void setRecepientHAddress(String recepientHAddress) {
        RecepientHAddress = recepientHAddress;
    }

    public String getRecepientHSourceAddress() {
        return RecepientHSourceAddress;
    }

    public void setRecepientHSourceAddress(String recepientHSourceAddress) {
        RecepientHSourceAddress = recepientHSourceAddress;
    }
    ...
    public void setisActiveDelivery(String isActiveDelivery) {
    ...
    public void setFare_Payable(String fare_Payable) {
        Fare_Payable = fare_Payable;
    }

    public void setePaymentBy(String ePaymentBy) {

        this.ePaymentBy = ePaymentBy;
    }

    String RecepientName = "";
    String IsActiveDelivery = "";
    String RecepientHName = "";
    String BGColor="";
    String TEXTColor = "";
    ...
    String RecepientNum = "";
    String RecepientHNum = "";
    String RecepientAddress = "";
    String RecepientHAddress = "";
    String RecepientSourceAddress = "";
    String RecepientHSourceAddress = "";
    ...
    public String getRecepientSourceAddress() {
        return RecepientSourceAddress;
    }

    public void setRecepientSourceAddress(String recepientSourceAddress) {
        RecepientSourceAddress = recepientSourceAddress;
    }
    ...
    String LBL_RECIPIENT, LBL_Status, LBL_CANCELED_TRIP_TXT, LBL_FINISHED_TRIP_TXT, LBL_PICK_UP_INS, LBL_DELIVERY_INS, LBL_PACKAGE_DETAILS, LBL_CALL_TXT, LBL_MESSAGE_ACTIVE_TRIP, LBL_RESPONSIBLE_FOR_PAYMENT_TXT, LBL_MULTI_AMOUNT_COLLECT_TXT;
    ...
    public String getLBL_MULTI_AMOUNT_COLLECT_TXT() {
        return LBL_MULTI_AMOUNT_COLLECT_TXT;
    }

    public void setLBL_MULTI_AMOUNT_COLLECT_TXT(String LBL_MULTI_AMOUNT_COLLECT_TXT) {
        this.LBL_MULTI_AMOUNT_COLLECT_TXT = LBL_MULTI_AMOUNT_COLLECT_TXT;
    }
    ...
    /*For Trip detail*/
    String LBL_DROP_OFF_LOCATION_TXT, LBL_DELIVERY_STATUS_TXT, LBL_VIEW_SIGN_TXT, Receipent_Signature;
