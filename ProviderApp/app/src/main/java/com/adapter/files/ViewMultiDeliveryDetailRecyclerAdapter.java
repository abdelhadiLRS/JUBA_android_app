...
public class ViewMultiDeliveryDetailRecyclerAdapter extends RecyclerView.Adapter<ViewMultiDeliveryDetailRecyclerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        viewHolder.arrowArea.setOnClickListener(view -> {
            ...
            if (viewHolder.recipientDetailArea.getVisibility() == View.VISIBLE) {
                ...
                if (isCancelled || iActive.contains("Finished") || isFromHistory || item.getShowMobile().equals("No")) {
                    viewHolder.callMsgArea.setVisibility(View.GONE);
                } else {
                    viewHolder.callMsgArea.setVisibility(View.VISIBLE);
                }
                mActivity.scrollToPosition();
        ...
        if (list_item.size() == 1) {
            ...
            viewHolder.nextDeliveryLocArea.setVisibility(View.VISIBLE);
        ...
        if (item.getShowMobile().equals("Yes")) {
            ...
            /*if (item.getePaymentBy().equalsIgnoreCase("Individual")) {
                viewHolder.amountToPayTitleTxt.setText(item.getLBL_MULTI_AMOUNT_COLLECT_TXT());
                viewHolder.amountToPayTxt.setText(item.getFare_Payable());
        ...
        if (isFromHistory) {
            viewHolder.callMsgArea.setVisibility(View.GONE);
            viewHolder.amountArea.setVisibility(View.GONE);
        }
    ...
    public void isFromHistory(boolean b) {
        isFromHistory=b;
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        CardView statusArea;
        MTextView tripstatusTxt, recipient_no_txt;
        ...
        public ViewHolder(View view) {
            super(view);
            recipientDetailArea = view.findViewById(R.id.recipientDetailArea);
            deliveryDetailsList = view.findViewById(R.id.deliveryDetailsList);
            cv2 = view.findViewById(R.id.cv2);
            nextDeliveryLocTxt = view.findViewById(R.id.nextDeliveryLocTxt);
            recipientNoTxt = view.findViewById(R.id.recipientNoTxt);
            recipientNameTxt = view.findViewById(R.id.recipientNameTxt);
            recipientPhnNumberTxt = view.findViewById(R.id.recipientPhnNumberTxt);
            recipientAddressTxt = view.findViewById(R.id.recipientAddressTxt);
            upcomingDeliveryLocTxt = view.findViewById(R.id.upcomingDeliveryLocTxt);

            contactTxt = view.findViewById(R.id.contactTxt);
            cancelTxt = view.findViewById(R.id.cancelTxt);
            responsibleForPaymentTxt = view.findViewById(R.id.responsibleForPaymentTxt);
            responsibleForPaymentArea = view.findViewById(R.id.responsibleForPaymentArea);
            ...
            int backColor = mActivity.getActContext().getResources().getColor(R.color.mdtp_transparent_full);
            ...
            ViewGroup layout = (ViewGroup) view.findViewById(R.id.cv2);
