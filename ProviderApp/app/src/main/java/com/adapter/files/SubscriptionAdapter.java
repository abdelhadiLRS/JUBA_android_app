...
public class SubscriptionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            ...
            viewHolder.subScribeBtnTxt.setOnClickListener(view -> {
                if (mItemClickListener != null) {
                    mItemClickListener.onSubscribeItemClick(view, position, "Cancel");
                }
            });

            viewHolder.renewBtnTxt.setOnClickListener(view -> {
                if (mItemClickListener != null) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public MButton subScribeBtnTxt;
        public MButton renewBtnTxt;
        ...
        public ViewHolder(View view) {
            ...
            subScribeBtnTxt = ((MaterialRippleLayout) view.findViewById(R.id.subScribeBtnTxt)).getChildView();
            renewBtnTxt = ((MaterialRippleLayout) view.findViewById(R.id.renewBtnTxt)).getChildView();
