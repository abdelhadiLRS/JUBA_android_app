    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            ...
            if (!vServiceCategoryName.isEmpty()){
                ...
                viewHolder.orderNoTxtView.setGravity(Gravity.END);
            ...
            viewHolder.orderHotelAddress.setText(item.get("vUserAddress") );
            ...
            if (Utils.checkText(image_url)) {
                ...
                new LoadImage.builder(LoadImage.bind(Utils.getResizeImgURL(mContext, image_url, imagewidth, imagewidth)), viewHolder.storeImgView).setErrorImagePath(R.mipmap.ic_no_pic_user).setPlaceholderImagePath(R.mipmap.ic_no_pic_user).build();
