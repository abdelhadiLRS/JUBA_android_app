        ...
        if (holder instanceof ViewHolder) {
            ...
            if (Utils.checkText(item.getIsGenie()) && item.getIsGenie().equalsIgnoreCase("Yes")) {
                ...
                if (item.getItemDetailsUpdated().equalsIgnoreCase("No")) {
                    viewHolder.editImg.setImageResource(R.drawable.ic_v_add_theme);
                } else {
                    viewHolder.editImg.setImageResource(R.drawable.ic_v_edit_theme);
            ...
            viewHolder.item_list_detail_cv.setOnClickListener(view -> {
            ...
            if (isImageShow || (Utils.checkText(item.getIsGenie()) && item.getIsGenie().equalsIgnoreCase("Yes"))) {
                ...
                if (isImageShow || item.getvImageUploaded() != null && item.getvImageUploaded().equalsIgnoreCase("Yes")) {
                    ...
                    new LoadImage.builder(LoadImage.bind(vImage), viewHolder.itemImg).setErrorImagePath(R.mipmap.ic_no_icon).setPlaceholderImagePath(R.mipmap.ic_no_icon).setPicassoListener(new LoadImage.PicassoListener() {
                        @Override
            ...
            viewHolder.editImg.setOnClickListener(view -> mItemClickListener.onItemImageUpload(position));
            ...
            if (item.geteDecline() != null && item.geteDecline().equalsIgnoreCase("Yes")) {
                ...
                viewHolder.itemPriceTxt.setVisibility(View.VISIBLE);
                if (subItemList.get(position).getItemPrice() != null && subItemList.get(position).getItemPrice().equalsIgnoreCase("--")) {
                    viewHolder.itemPriceTxt.setVisibility(View.GONE);
                }
