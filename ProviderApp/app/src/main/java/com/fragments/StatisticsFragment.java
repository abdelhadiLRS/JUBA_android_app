...
public class StatisticsFragment extends BaseFragment {
    ...
    int type;
    LinearLayout chartContainer, toparea;
    ...
    public void onResume() {
      ...
      //  image_1.setImageResource(R.drawable.ic_list_format);
    }
