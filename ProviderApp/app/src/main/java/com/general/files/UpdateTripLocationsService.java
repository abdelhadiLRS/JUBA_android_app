...
public class UpdateTripLocationsService extends Service implements RecurringTask.OnTaskRunCalled, GetLocationUpdates.LocationUpdatesListener {
    ...
    public void startUpdate(String generatedTripId) {
        ...
        updateDriverLocationsTask = new RecurringTask(UPDATE_TIME_INTERVAL);
    ...
    public void updateDriverLocations() {
        ...
        if (store_locations.size() > 0 && IsdataUploading == false) {
           ...
           /* if (this.currentExeTask != null) {
            ...
            this.currentExeTask = ApiHandler.execute(getApplicationContext(), parameters, new ServerTask.SetDataResponse() {
                @Override
