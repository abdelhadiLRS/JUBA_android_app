...
public class GetFeatureClassList {
    ...
    public static HashMap<String, String> getAllGeneralClasses() {
        ...
        biddingClassList.add(BuildConfig.APPLICATION_ID + ".BiddingViewDetailsActivity");
        ...
        biddingClassList.add(BuildConfig.APPLICATION_ID + ".BiddingCategoryActivity");
        ...
        deliverAllClassList.add(BuildConfig.APPLICATION_ID + ".deliverAll.LiveTrackOrderDetail2Activity");
        deliverAllClassList.add(resourceFilePath + "activity_live_track_order_new_detail");
        deliverAllClassList.add(BuildConfig.APPLICATION_ID + ".deliverAll.UserPrefrenceActivity");
        ...
        rduModuleClassList.add(BuildConfig.APPLICATION_ID + ".AdditionalChargeActivity");
        ...
        rduModuleClassList.add(BuildConfig.APPLICATION_ID + ".WorkingtrekActivity");
