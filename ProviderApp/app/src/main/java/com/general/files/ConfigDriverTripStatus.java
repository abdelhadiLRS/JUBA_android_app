...
public class ConfigDriverTripStatus implements GetLocationUpdates.LocationUpdatesListener, RecurringTask.OnTaskRunCalled {
    Context mContext;
    ...
    private RecurringTask updateDriverStatusTask;
    ...
    public void startDriverStatusUpdateTask() {
        ...
        if (mContext != null) {
            ...
            updateDriverStatusTask = new RecurringTask(FETCH_TRIP_STATUS_TIME_INTERVAL * 1000);
            ...
            try {
                if (workRequest != null) {
                    WorkManager.getInstance(mContext).cancelUniqueWork("ConfigDriverTripStatusJobService");
                }
...
//                dispatcher.mustSchedule(myJob);
                ...
                workRequest = new PeriodicWorkRequest.Builder(ConfigDriverTripStatusJobService.class, FETCH_TRIP_STATUS_TIME_INTERVAL, TimeUnit.MINUTES)
                        ...
                        .addTag("ConfigDriverTripStatusJobService")
                        .build();
    ...
    private void updateDriverTripStatus() {
        ...
        if (MyApp.getInstance() != null) {
            if (MyApp.getInstance().driverArrivedAct != null || MyApp.getInstance().activeTripAct != null) {
                ...
                if (MyApp.getInstance().activeTripAct != null) {
                    ...
                    iTripId = (String) MyApp.getInstance().activeTripAct.data_trip.get("TripId");
                } else {
        ...
        if (MyApp.getInstance().main22Act != null) {
            parameters.put("isSubsToCabReq", "" + MyApp.getInstance().main22Act.isDriverOnline);
        }
...
//                        }
    ...
    public void onLocationUpdate(Location location) {
        ...
        Logger.d("GetLocation", "::onLocationUpdateConfig" + location);
