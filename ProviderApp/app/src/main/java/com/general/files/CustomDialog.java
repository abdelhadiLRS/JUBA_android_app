...
public class CustomDialog {
    ...
    MButton tv_Proceed_Button,tv_Cancel_Button,tv_Positive_Button,tv_Negative_Button;
    ImageView iv_icon;
    ...
    protected void createCustomDialog() {
        ...
        customDialog.getWindow().setLayout(width, ViewGroup.LayoutParams.MATCH_PARENT);
        ...
        final ImageView dialogImgView = (ImageView) customDialog.findViewById(R.id.dialogImgView);
        final LinearLayout verticalButtonArea = (LinearLayout) customDialog.findViewById(R.id.verticalButtonArea);
        final LinearLayout ll_tv_Cancel_Button = (LinearLayout) customDialog.findViewById(R.id.ll_tv_Cancel_Button);
        final LinearLayout ll_tv_Proceed_Button = (LinearLayout) customDialog.findViewById(R.id.ll_tv_Proceed_Button);
        final LinearLayout ll_tv_Positive_Button = (LinearLayout) customDialog.findViewById(R.id.ll_tv_Positive_Button);
        final LinearLayout ll_tv_Negative_Button = (LinearLayout) customDialog.findViewById(R.id.ll_tv_Negative_Button);
        dividerview = (View) customDialog.findViewById(R.id.dividerview);
...
*/
        ...
        if (Utils.checkText(positiveBtnTxt)) {
            ll_tv_Positive_Button.setVisibility(View.VISIBLE);
            ...
            if (btnOrientation == 1) {
                ll_tv_Proceed_Button.setVisibility(View.VISIBLE);
                tv_Proceed_Button.setText(positiveBtnTxt);
            }
        }

        if (Utils.checkText(negativeBtnTxt)) {
            ll_tv_Negative_Button.setVisibility(View.VISIBLE);
            ...
            if (btnOrientation == 1) {
                ll_tv_Cancel_Button.setVisibility(View.VISIBLE);
                tv_Cancel_Button.setText(negativeBtnTxt);
            }

        }
        if(ll_tv_Cancel_Button.getVisibility() == View.GONE){
