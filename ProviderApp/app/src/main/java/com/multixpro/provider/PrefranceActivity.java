...
public class PrefranceActivity extends ParentActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    String HANDICAP_ACCESSIBILITY_OPTION = "";
    String FEMALE_RIDE_REQ_ENABLE = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkboxHandicap =  findViewById(R.id.checkboxHandicap);
        ...
        addToClickHandler(update_btn);
        checkboxFemale.setOnCheckedChangeListener(this);
        checkboxHandicap.setOnCheckedChangeListener(this);
        setLabel();

        FEMALE_RIDE_REQ_ENABLE = generalFunc.retrieveValue(Utils.FEMALE_RIDE_REQ_ENABLE);
        HANDICAP_ACCESSIBILITY_OPTION = generalFunc.retrieveValue(Utils.HANDICAP_ACCESSIBILITY_OPTION);

        if (!FEMALE_RIDE_REQ_ENABLE.equalsIgnoreCase("Yes")) {
            checkboxFemale.setVisibility(View.GONE);
        } else {
            checkboxFemale.setVisibility(View.VISIBLE);
        }

        if (generalFunc.getJsonValueStr("eFemaleOnlyReqAccept", obj_userProfile).equalsIgnoreCase("Yes")) {
