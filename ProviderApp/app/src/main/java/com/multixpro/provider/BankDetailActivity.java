...
public class BankDetailActivity extends ParentActivity {
    ...
    private void isBankDetailDisplay(String vPaymentEmail, String vBankAccountHolderName, String vAccountNumber, String vBankLocation, String vBankName,
        ...
        ApiHandler.execute(getActContext(), parameters, loadingBar.getVisibility() != View.VISIBLE, false, generalFunc,
                responseString -> {
                    ...
                    if (responseStringObject != null && !responseStringObject.equals("")) {
                        ...
                        if (isDataAvail) {
                            ...
                            vAccountNumber1 = generalFunc.getJsonValueStr("vAccountNumber", msg_obj);
                            ...
                            if (isAlert) {
                                ...
                                alertBox.setBtnClickList(btn_id -> {
                                    if (btn_id == 1) {
                                        if (Utils.checkText(from) && from.equalsIgnoreCase("walletWithDraw") && !vAccountNumber1.equalsIgnoreCase("")) {
                                            Intent returnIntent = new Intent();
                                            returnIntent.putExtra("vAccountNumber", vAccountNumber1);
    ...
    private void checkData() {
        ...
        if (!isPaymentEmail  || !isBankAccountHolderName || !isAccountNumber  || !isBankLocation  || !isBankName  ||!isSwiftCode) {
            return;
        }
