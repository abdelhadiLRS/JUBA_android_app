...
//        shareTxt.setText(generalFunc.retrieveLangLBl("", "LBL_INVITE_FRIEND_SHARE_TXT"));
        shareTxt.setText(generalFunc.convertNumberWithRTL(generalFunc.getJsonValueStr("INVITE_DESCRIPTION_CONTENT", obj_userProfile)));
        vRefCode = generalFunc.getJsonValueStr("vRefCode", obj_userProfile);
