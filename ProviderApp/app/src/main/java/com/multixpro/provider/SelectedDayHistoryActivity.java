...
public class SelectedDayHistoryActivity extends ParentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listCancelContainer = findViewById(R.id.listCancelContainer);
        fareHTxt = findViewById(R.id.fareHTxt);
        tripsCountTxt = findViewById(R.id.tripsCountTxt);
    ...
    public void setData(boolean isDataAvail, JSONObject responseString) {
        ...
        if (isDataAvail) {
            ...
            if (msgArr != null) {
                ...
                for (int i = 0; i < msgArr.length(); i++) {
                    ...
                    if (generalFunc.isRTLmode()) {
                        ( customView.findViewById(R.id.arrowImgView)).setRotation(-180);
                    }
            ...
            ( findViewById(R.id.tripEarningTxt)).setVisibility(View.VISIBLE);
        } else {
            tripCancelTxt.setVisibility(View.GONE);
            ...
            ( findViewById(R.id.tripEarningTxt)).setVisibility(View.GONE);
        }
    ...
    public void generateErrorView() {
        ...
        errorView.setOnRetryListener(() -> getDetails());
    }
    ...
    public class setOnClickList implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (isTripItemClick) {
                ...
                new ActUtils(getActContext()).startActWithData(RideHistoryDetailActivity.class, bn);
            } else {
                int i = view.getId();
