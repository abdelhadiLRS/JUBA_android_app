...
public class AddVehicleActivity extends ParentActivity implements VehicleSingleCheckListAdapter.OnItemClickListener {
    ...
    private void removeInput() {
        ...
        addToClickHandler(vehicleTypeBox);
        ...
        if (!ServiceModule.isDeliverAllOnly()) {
            for (int i = 0; i < vehicleTypeListSize; i++) {
                ...
                if (eType.equalsIgnoreCase(Utils.eSystem_Type)) {
                    ...
                    LinearLayout helperArea = (LinearLayout) view.findViewById(R.id.helperArea);
                    ...
                    MTextView deliverhelperTxt = (MTextView) view.findViewById(R.id.deliverhelperTxt);
                    ImageView deliveryHelperimg = (ImageView) view.findViewById(R.id.deliveryHelperimg);
