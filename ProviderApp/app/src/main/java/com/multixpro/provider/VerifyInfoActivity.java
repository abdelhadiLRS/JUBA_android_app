...
public class VerifyInfoActivity extends ParentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        maxAllowdCount = GeneralFunctions.parseIntegerValue(5, generalFunc.getJsonValueStr(Utils.VERIFICATION_CODE_RESEND_COUNT_KEY, obj_userProfile));
        resendTime = GeneralFunctions.parseIntegerValue(30, generalFunc.getJsonValueStr(Utils.VERIFICATION_CODE_RESEND_COUNT_RESTRICTION_KEY, obj_userProfile));
        ...
        smsOTPTitleTxt = ((MTextView) findViewById(R.id.smsOTPTitleTxt));
        phonetxt = ((MTextView) findViewById(R.id.phoneTxt));
        emailTxt = ((MTextView) findViewById(R.id.emailTxt));
        smsOTPTitleTxt.setText(generalFunc.retrieveLangLBl("", "LBL_ENTER_DIGIT_OTP_TXT"));
        ...
        if (ServiceModule.isDeliverAllOnly() && (!isbackshow || isrestart)) {
    ...
    private void signInWithPhoneAuthCredential(PhoneAuthCredential credential) {
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(VerifyInfoActivity.this, task -> {
    ...
    public void resendProcess(final String showTimerFor) {
        ...
        if (Utils.checkText(showTimerFor)) {
            setTime(GeneralFunctions.parseLongValue(0L, String.valueOf(resendSecInMilliseconds)), showTimerFor);
            removecountDownTimer(showTimerFor);
            ...
            handler.postDelayed(() -> enableOrDisable(true, showTimerFor), resendSecInMilliseconds);
        }
    }
    ...
    public void updateProfile(String type, String email, String mobile, String countryCode, String vCode) {
        ...
        parameters.put("vPhoneCode", isMobile ? vCode : generalFunc.getJsonValueStr("vCode", obj_userProfile));
        ...
        parameters.put("CurrencyCode", generalFunc.getJsonValueStr("vCurrencyDriver", obj_userProfile));
        ...
        ApiHandler.execute(getActContext(), parameters, true, false, generalFunc, responseString -> {
            ...
            if (responseStringObj != null && !responseStringObj.equals("")) {
                ...
                if (isDataAvail) {
                    ...
                    vEmail = generalFunc.getJsonValueStr("vEmail", obj_userProfile);
                    vPhone = generalFunc.getJsonValueStr("vCode", obj_userProfile) + generalFunc.getJsonValue("vPhone", obj_userProfile);
    ...
    public void setData(String vCountryCode, String vPhoneCode, String vSImage) {
        ...
        vCode = vPhoneCode;
        isCountrySelected = true;
        ((EditText) editInfoDialog.findViewById(R.id.countryBox)).setText("+" + generalFunc.convertNumberWithRTL(vPhoneCode));
    }
}
