...
public class EmailStageActivity extends ParentActivity {
    ...
    public void registerUser() {
        ...
        parameters.put("vCompany", getIntent().getStringExtra("vCompany"));
        parameters.put("vEmail", Utils.getText(emailBox));
        ...
        parameters.put("vCurrency", generalFunc.retrieveValue(Utils.DEFAULT_CURRENCY_VALUE));
        parameters.put("vLang", generalFunc.retrieveValue(Utils.LANGUAGE_CODE_KEY));
        parameters.put("iServiceId", getIntent().getStringExtra("iServiceId"));

        generalFunc.storeData("iServiceId", getIntent().getStringExtra("iServiceId"));
