...
public class RestaurantDetailActivity extends ParentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (generalFunc.getJsonValueStr("SHOW_CITY_FIELD", obj_userProfile).equalsIgnoreCase("Yes")) {
        ...
        addToClickHandler(stateBox);
        addToClickHandler(cityBox);
...
//        zipBox.setInputType(InputType.TYPE_CLASS_NUMBER);
        zipBox.setFilters(new InputFilter[]{
                new InputFilter() {
                    ...
                    if (responseObj != null && !responseObj.equals("")) {
                        ...
                        if (isDataAvail == true) {
                            ...
                            for (int i = 0; i < arr_stateList.length(); i++) {
                                ...
                                if (Utils.getText(stateBox).equalsIgnoreCase(generalFunc.getJsonValueStr("vState", jobj))) {
                                    statePosition = i;
                                }
...
//                        selected_vState = generalFunc.getJsonValueStr("vState", jobj);
    ...
    public void removeInput() {
        ...
        addToClickHandler(restaurantLocationOnMapBox);
        addToClickHandler(stateBox);
        addToClickHandler(cityBox);
    }
    ...
    private void checkData() {
        ...
        int estimatedTIme = GeneralFunctions.parseIntegerValue(1, Utils.getText(estTimeEditBox));
    ...
    public void sendRestaurantDetail(String CALL_TYPE) {
        ...
        ApiHandler.execute(getActContext(), parameters, !CALL_TYPE.equals("Display") ? true : false, false, generalFunc,
                responseString -> {
                    ...
                    if (responseObj != null && !responseObj.toString().equals("")) {
                        ...
                        if (GeneralFunctions.checkDataAvail(Utils.action_str, responseObj)) {
                            ...
                            generalFunc.showGeneralMessage("", generalFunc.retrieveLangLBl("", generalFunc.getJsonValueStr(Utils.message_str, responseObj)), CALL_TYPE.equals("Display"));
                        }
                    } else {
                        generalFunc.showError();
                    }
