...
public class ListOfDocumentActivity extends ParentActivity implements ListOfDocAdapter.OnItemClickListener {
    ...
    public void getDocList() {
        ...
        parameters.put("type", "displayCompanyDocList");
        parameters.put("memberType", Utils.app_type);
        parameters.put("iMemberId", generalFunc.getMemberId());
        parameters.put("doc_usertype", Utils.app_type);
        ...
        ApiHandler.execute(getActContext(), parameters,
                responseString -> {
                    ...
                    if (responseObj != null && !responseObj.equals("")) {
                        ...
                        closeLoader();
                        if (generalFunc.checkDataAvail(Utils.action_str, responseObj)) {
...
//                        listOfDocRecyclerView.setAdapter(adapter);
                            ...
                            noDocumentsListTxt.setText(generalFunc.retrieveLangLBl("", generalFunc.getJsonValueStr(Utils.message_str, responseObj)));
