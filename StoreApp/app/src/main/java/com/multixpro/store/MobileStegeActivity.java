...
public class MobileStegeActivity extends ParentActivity {
    ...
    private void init() {
        ...
        soicalHintTxt.setText(generalFunc.retrieveLangLBl("", "LBL_SMART_LOGIN_APPLOGIN"));
 ...
 ClickableSpan ClickableSpan = new ClickableSpan() {
    ...
    private void manageSmartLogin() {
        if (mSmartLogin.checkPrivacyAdded()) {
            if (generalFunc.retrieveValue("isUserSmartLogin") != null && generalFunc.retrieveValue("isUserSmartLogin").equalsIgnoreCase("yes")) {
                socialArrow.setVisibility(View.VISIBLE);
                soicalHintTxt.setVisibility(View.VISIBLE);
