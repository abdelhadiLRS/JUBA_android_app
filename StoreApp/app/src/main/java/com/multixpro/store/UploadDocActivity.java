...
public class UploadDocActivity extends ParentActivity {
    ...
    private RelativeLayout selectyear_layout;
    ...
    private void checkData() {
        ...
        handler.postDelayed(() -> isbtnclick = false, 1000);

        ArrayList<String[]> paramsList = new ArrayList<>();
        paramsList.add(Utils.generateImageParams("type", "uploadcompanydocument"));
        ...
        paramsList.add(Utils.generateImageParams("iServiceId", generalFunc.getServiceId()));
        paramsList.add(Utils.generateImageParams("ex_date", getIntent().getStringExtra("ex_status").equals("yes") ? Utils.getText(expBoxTXT) : ""));
        paramsList.add(Utils.generateImageParams("iServiceId", generalFunc.getServiceId()));
        ...
        if (!getIntent().getStringExtra("doc_file").equals("")) {
            ...
            for (int i = 0; i < paramsList.size(); i++) {
                ...
                Logger.d("Parametres", "::" + arrData[0] + "," + arrData[1]);
            }
            uploadProfileImage = new UploadProfileImage(UploadDocActivity.this, selectedDocumentPath, "TempFile." + Utils.getFileExt(selectedDocumentPath), paramsList, "FILE");
            uploadProfileImage.execute(true, generalFunc.retrieveLangLBl("", "LBL_DOCUMET_UPLOADING"));
        ...
        DatePicker.show(getActContext(), generalFunc, Calendar.getInstance(), null, SELECTED_DATE, null, (year, monthOfYear, dayOfMonth) -> {
            ...
            try {
                ...
                if (cal != null) {
                    ...
                    expBoxTXT.setText(Utils.convertDateToFormat(CommonUtilities.DayFormatEN, cal));
                }
