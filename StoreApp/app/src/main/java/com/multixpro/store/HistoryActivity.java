...
public class HistoryActivity extends ParentActivity implements HistoryRecycleAdapter.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filterTxt = (MTextView) findViewById(R.id.filterTxt);
        ...
        avgRatingCalcTxt = (MTextView) findViewById(R.id.avgRatingCalcTxt);

        mainContent = (LinearLayout) findViewById(R.id.mainContent);
        mainContent.setVisibility(View.GONE);
        filterArea.setVisibility(View.GONE);

        historyRecyclerAdapter = new HistoryRecycleAdapter(getActContext(), listData, generalFunc, true);
...
//        SimpleDateFormat formatter = new SimpleDateFormat(dateFormat);
    ...
    private void addCalenderView() {
        calenderHeaderLayout = findViewById(R.id.calenderHeaderLayout);
        ...
        titleContainerView = findViewById(R.id.titleContainerView);
                ...
                responseString -> {
                    ...
                    if (responseObj != null && !responseObj.equals("")) {
                        ...
                        if (generalFunc.checkDataAvail(Utils.action_str, responseObj) == true) {
                            ...
                            String AvgRating = generalFunc.convertNumberWithRTL(generalFunc.getJsonValueStr("AvgRating", responseObj));


                            Log.d("AvgRating", "getPastOrders: " + AvgRating);
                            if (AvgRating.isEmpty()) AvgRating = "0.0";

                            ((MTextView) findViewById(R.id.avgRatingCalcTxt)).setText("" + GeneralFunctions.parseFloatValue(0, Utils.checkText(AvgRating) ? AvgRating : "0"));
