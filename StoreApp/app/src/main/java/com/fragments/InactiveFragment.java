...
import com.multixpro.store.SetAvailabilityActivity;
...
public class InactiveFragment extends BaseFragment implements InactiveRecycleAdapter.OnItemClickList {
    ...
    public void onItemClick(int position) {
        ...
        if (position == 1) {
            ...
            new ActUtils(mainActivity.getActContext()).startActWithData(RestaurantDetailActivity.class, bn);
        } else if (position == 2) {
            Bundle bn = new Bundle();
            bn.putString("PAGE_TYPE", "Company"); //Driver
            bn.putString("iDriverVehicleId", "");
            bn.putString("doc_file", "");
            bn.putString("iDriverVehicleId", "");
            new ActUtils(mainActivity.getActContext()).startActWithData(ListOfDocumentActivity.class, bn);
        } else if (position == 3) {
            Bundle bn = new Bundle();

            new ActUtils(getActivity()).startActWithData(SetWorkingHoursActivity.class, bn);
    ...
    public void getDriverStateDetails() {
        ...
        ApiHandler.execute(mainActivity.getActContext(), parameters, true, false, generalFunc,
