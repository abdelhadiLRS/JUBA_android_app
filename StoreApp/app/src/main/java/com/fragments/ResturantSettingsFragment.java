...
public class ResturantSettingsFragment extends BaseFragment implements CompoundButton.OnCheckedChangeListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        addToClickHandler(setRestaurantDetailsArea);
        addToClickHandler(setBusinessHoursArea);
