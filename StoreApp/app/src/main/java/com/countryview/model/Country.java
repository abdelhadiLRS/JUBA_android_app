...
public class Country {
    ...
    @SerializedName("vPhoneCodeWithPlusSign")
    private String vPhoneCodeWithPlusSign;
    ...
    public Country(String mName, String mCode, String mDialCode, String mDialCodeWithPlusSign, String mFlag, String mViewType, Country setHeaderSection) {
        this.mName = mName;
        this.mCode = mCode;
        ...
        this.setHeaderSection = setHeaderSection;
        this.vPhoneCodeWithPlusSign = mDialCodeWithPlusSign;
    }
    ...
    public String getvPhoneCodeWithPlusSign() {
        return vPhoneCodeWithPlusSign;
    }
}
