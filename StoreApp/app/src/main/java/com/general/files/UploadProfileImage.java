...
import com.multixpro.store.UploadDocActivity;
...
public class UploadProfileImage implements DataReqBody.UploadCallbacks /*extends AsyncTask<String, String, String>*/ {
    ...
    public void execute() {
        ...
        if (filePath.equals("")) {
            ...
            call.enqueue(new Callback<Object>() {
                ...
                public void onResponse(Call<Object> call, Response<Object> response) {
                    Logger.d("onResponse", "::" + responseString);
                ...
                public void onFailure(Call<Object> call, Throwable t) {
                    Logger.d("onResponse", "::error::" + responseString + "::" + t.getMessage());
        ...
        MultipartBody.Part filePart = MultipartBody.Part.createFormData("vImage", temp_File_Name, new DataReqBody(MediaType.parse("multipart/form-data"), file, this));
