...
//			convertView.setAlpha((float) 0.96);
            ...
            new LoadImage.builder(LoadImage.bind(countryListItem.getvRImage()), img).build();
            RelativeLayout mainView = (RelativeLayout) convertView.findViewById(R.id.mainView);
//			txt_count.setVisibility(View.GONE);
