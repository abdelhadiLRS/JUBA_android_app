...
public class HistoryRecycleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public HistoryRecycleAdapter(Context mContext, ArrayList<HashMap<String, String>> list, GeneralFunctions generalFunc, boolean isFooterEnabled) {
        ...
        LBL_BOOKING_NO = generalFunc.retrieveLangLBl("", "LBL_BOOKING");
        LBL_ORDER = generalFunc.retrieveLangLBl("", "LBL_ORDER");
        LBL_ORDER = generalFunc.retrieveLangLBl("", "LBL_ORDER");
    }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            ...
            viewHolder.myBookingNoHTxt.setText(LBL_ORDER);
            viewHolder.totalItemsTxtView.setText(item.get("TotalItemsConverted") + " " + item.get("LBL_ITEMS"));
            viewHolder.sAddressTxt.setText(item.get("vUserAddress"));
            ...
            if (Utils.checkText(image_url)) {
                ...
                new LoadImage.builder(LoadImage.bind(Utils.getResizeImgURL(mContext, image_url, imagewidth, imagewidth)), viewHolder.userImgView).setErrorImagePath(R.mipmap.ic_no_pic_user).setPlaceholderImagePath(R.mipmap.ic_no_pic_user).build();
            } else {
