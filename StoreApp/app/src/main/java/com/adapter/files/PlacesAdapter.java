...
public class PlacesAdapter extends RecyclerView.Adapter<PlacesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(PlacesAdapter.ViewHolder holder, final int position) {
        ...
        HashMap<String, String> itemData = recentList.get(position);
        holder.addressText.setText(itemData.get("main_text"));
        holder.subAddressText.setText(itemData.get("secondary_text"));
