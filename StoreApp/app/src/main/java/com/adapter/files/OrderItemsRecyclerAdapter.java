...
public class OrderItemsRecyclerAdapter extends RecyclerView.Adapter<OrderItemsRecyclerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        ...
        if(item.get("vSKU") == null || item.get("vSKU").equals("")) {
            viewHolder.skuTxt.setVisibility(View.GONE);
        } else {
            viewHolder.skuTxt.setVisibility(View.VISIBLE);
            viewHolder.skuTxt.setText(generalFunc.retrieveLangLBl("","LBL_MENU_ITEM_SKU_CODE_TXT") + ": " + item.get("vSKU"));
        }
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            skuTxt = (MTextView) view.findViewById(R.id.skuTxt);
