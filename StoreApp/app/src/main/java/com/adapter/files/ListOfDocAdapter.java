...
public class ListOfDocAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            ...
            new CreateRoundedView(Color.parseColor("#ffffff"),(int)mContext.getResources().getDimension(R.dimen._6sdp),2,mContext.getResources().getColor(R.color.requestTimerColor),viewHolder.main_layout);
            ...
            if (item.get("doc_file").equals("")) {
                ...
                viewHolder.infoImg.setImageDrawable(mContext.getResources().getDrawable(R.drawable.ic_warning));
            ...
            if (vImage.equals("")) {
                ...
                viewHolder.docImgView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        new ActUtils(mContext).openURL(vImage);
                    }
                });
            ...
            if (generalFunc.isRTLmode()){
                viewHolder.indicatorImg.setRotation(90);
            }else {
                viewHolder.indicatorImg.setRotation(-90);
            }
