...
public class StopOverPointsDataParser {
    ...
    public StopOverPointsDataParser(Context mContext, ArrayList<Stop_Over_Points_Data> list, ArrayList<Stop_Over_Points_Data> wayPointslist, ArrayList<Stop_Over_Points_Data> destPointlist, ArrayList<Stop_Over_Points_Data> finalPointlist, GeoMapLoader.GeoMap geoMap, LatLngBounds.Builder builder) {
            ...
            for (int i = 0; i < jRoutes.length(); i++) {
                ...
                for (int j = 0; j < jLegs.length(); j++) {
                   ...
                   // dt.setDistance(dis);
                    ...
                    long vTime = GeneralFunctions.parseLongValue(0, generalFunc.getJsonValue("value", durationObj.toString()));
                  ...
                  //  dt.setTime(vTime);
                    ...
                    double lat = GeneralFunctions.parseDoubleValue(0.0, generalFunc.getJsonValue("lat", end_location.toString()).toString());
                    double lng = GeneralFunctions.parseDoubleValue(0.0, generalFunc.getJsonValue("lng",
                    ...
                    if (j != jLegs.length() - 1) { //avoid last destination marker add
                        ...
                        Marker dest_marker = geoMap.addMarker(dest_dot_option);
            ...
            for (int i = 0; i < jRoutes.length(); i++) {
                ...
                for (int j = 0; j < jLegs.length(); j++) {
                   ...
                   // Multi_Dest_Info_Detail_Data dt = new Multi_Dest_Info_Detail_Data();
                    ...
                    long dis = GeneralFunctions.parseLongValue(0, generalFunc.getJsonValue("value",
                            distanceObj.toString()));
                  //  dt.setDistance(dis);
                    ...
                    long vTime = GeneralFunctions.parseLongValue(0, generalFunc.getJsonValue("value",
