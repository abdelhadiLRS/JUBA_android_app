...
import com.multixpro.user.AdditionalChargeActivity;
import com.multixpro.user.BiddingTaskActivity;
import com.multixpro.user.BookingActivity;
import com.multixpro.user.ChatActivity;
import com.multixpro.user.ConfirmEmergencyTapActivity;
import com.multixpro.user.HistoryDetailActivity;
import com.multixpro.user.MainActivity;
import com.multixpro.user.OnGoingTripDetailsActivity;
import com.multixpro.user.OnGoingTripsActivity;
import com.multixpro.user.PaymentWebviewActivity;
import com.multixpro.user.RatingActivity;
import com.multixpro.user.UberXHomeActivity;
import com.multixpro.user.deliverAll.OrderPlaceConfirmActivity;
import com.multixpro.user.deliverAll.TrackOrderActivity;
import com.multixpro.user.rentItem.RentItemListPostActivity;
import com.multixpro.user.rideSharing.RideBookingRequestedActivity;
import com.multixpro.user.trackService.PairCodeGenrateActivity;
import com.multixpro.user.trackService.TrackAnyList;
import com.multixpro.user.trackService.TrackAnyLiveTracking;
