...
import com.multixpro.user.BookingActivity;
import com.multixpro.user.BusinessProfileActivity;
import com.multixpro.user.ContactUsActivity;
import com.multixpro.user.DonationActivity;
import com.multixpro.user.EmergencyContactActivity;
import com.multixpro.user.FavouriteDriverActivity;
import com.multixpro.user.HelpActivity23Pro;
import com.multixpro.user.InviteFriendsActivity;
import com.multixpro.user.ManageAccountActivity;
import com.multixpro.user.MenuSettingActivity;
import com.multixpro.user.MobileStegeActivity;
import com.multixpro.user.MyProfileActivity;
import com.multixpro.user.MyWalletActivity;
import com.multixpro.user.NotificationActivity;
import com.multixpro.user.PaymentWebviewActivity;
import com.multixpro.user.R;
import com.multixpro.user.SearchPickupLocationActivity;
import com.multixpro.user.StaticPageActivity;
import com.multixpro.user.VerifyInfoActivity;
import com.multixpro.user.deliverAll.EditCartActivity;
import com.multixpro.user.giftcard.GiftCardRedeemActivity;
import com.multixpro.user.giftcard.GiftCardSendActivity;
import com.multixpro.user.rentItem.RentItemListPostActivity;
