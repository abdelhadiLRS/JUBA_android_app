                                ...
                                if (deliveriesArray != null && deliveriesArray.length() > 0) {
                                    ...
                                    for (int j = 0; j < deliveriesArray.length(); j++) {
                                        ...
                                        if (vFieldName.equalsIgnoreCase("Recepient Name") || (generalFunc.getJsonValueStr("iDeliveryFieldId", jobject1).equalsIgnoreCase("2"))) {
                                            ...
                                            recipientDetailMap1.setRecepientAddress(generalFunc.fromHtml(generalFunc.getJsonValue("tDaddress", jobject1.toString())).toString());
                                            recipientDetailMap.setiTripDeliveryLocationId(generalFunc.fromHtml(generalFunc.getJsonValue("iTripDeliveryLocationId", jobject1.toString())).toString());
