package com.multixpro.user.giftcard;
...
import com.multixpro.user.databinding.ActivityGiftcardSendBinding;
import com.multixpro.user.giftcard.adapter.GiftCardImagePagerAdapter;
