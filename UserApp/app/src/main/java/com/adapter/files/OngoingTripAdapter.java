...
//            viewHolder.liveTrackBtnArea.setVisibility(View.GONE);
            ...
            viewHolder.liveTrackBtnArea.setOnClickListener(view -> {
            ...
            viewHolder.verifyChargesBtnArea.setOnClickListener(view -> {
                if (mItemClickListener != null) {
                    mItemClickListener.onItemClickList("Verify Charge", position);
                }
            });

            viewHolder.viewDetailsBtnArea.setOnClickListener(view -> {
                if (mItemClickListener != null) {
            ...
            new LoadImage.builder(LoadImage.bind(image_url), viewHolder.user_img).setErrorImagePath(R.mipmap.ic_no_pic_user).setPlaceholderImagePath(R.mipmap.ic_no_pic_user).build();
        } else {
